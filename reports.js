...
function downloadExcels() {
  ...
  excelData.push([
    ...
    XLSX.utils.book_append_sheet(
        wb,
        ws,
        "Fino Payment Bank Daily Report"
    );
...
async function downloadPDF(printMode = false) {
	debugger
...
doc.text(
    "DHANDAI ENTERPRISES CASH MANAGEMENT SYSTEM",
    105,
    14,
    { align: "center" }
);
...
doc.text(
    ...
    "Generated by DHANADAI ENTERPRISES CASH Management System",
    105,
    pageHeight - 14,
    { align: "center" }
);
